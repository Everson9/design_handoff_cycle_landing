...
- **Brilho encostando na borda do quadro NÃO é sinal de corte.** Numa animação com glow, o rastro
  de luz sangrar até a borda é intencional e fica bom. Medir isso por brilho de borda dá falso
  positivo — foi assim que uma sessão cortou metade do vídeo do logo por engano. **A única
  verificação válida é olhar o quadro inteiro**, extraindo frames com
  `ffmpeg -ss <t> -i <v> -frames:v 1 saida.png` e vendo se o objeto está seccionado.
- **Quando o vídeo parecer cortado na tela, suspeitar do `object-fit` antes do arquivo.** `cover`
  num vídeo 16:9 dentro de janela mais larga que alta corta ~20–25% em cima e embaixo.
